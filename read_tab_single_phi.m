...
for i_b = 1: n_beobachtungen
    ...
    % Aktuelle Beobachtung des jeweiligen Fisches
...
for i_f = 1 : length(fischnummern)
    ...
    T_fisch_mean{i_f,3} = circ_rad2ang(circ_mean(T_fisch_alle{ind_f,4}));  
    ...
    % Beobachtung
    T_fisch_mean{i_f,6} = circ_rad2ang(circ_std(T_fisch_alle{ind_f,4}));
