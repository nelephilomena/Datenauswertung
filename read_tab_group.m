function [x_vec,y_vec,r_vec,phi_vec,time_sim,time_duration,phi_kompass] = ...
         read_tab_group(filename)

% Die Funktion liest die Daten mit dem Namen filename ein.
% udn erstellt einen Vektor mit den jeweiligen x- und y-Werten. Es werden 
% fuer jeden Beobachtungszeitschritt sowie Fisch der jeweilige Radius r,
